...
export default function SetupPage() {
  return (
    <AppShell active="setup">
      ...
      <section id="review" className="review-panel" aria-labelledby="review-title"><span className="hero-tag">PHASE 2 — IN PROGRESS</span><h2 id="review-title">Voice prototype working. Authentication and dashboard added.</h2><p>Deliverable 3 (Python LiveKit worker, Sarvam STT/TTS, Silero VAD) is implemented and confirmed working by the owner. Authentication (Clerk), a real dashboard, and agent/campaign/lead management are now being built.</p><p className="panel-footnote">Telugu, Hindi, Indian English, and Tenglish voice quality, caller-perceived p95 latency, and telephone connectivity (Exotel) are still unverified. Razorpay billing and WhatsApp integration are future milestones.</p></section>
    </AppShell>
  );
}
